...
public static class AppUtils
{
    ...
    /// 获取登录人编号
    /// </summary>
    public static long LoginId => Token.Id;

    /// <summary>
    /// 获取租户编号
    /// </summary>
    public static string LoginUser => Token.FullName;

    /// <summary>
    /// 获取租户编号
    /// </summary>
    public static long TenantId => Token.TenantId;

    /// <summary>
    /// 获取员工编号
    /// </summary>
    public static long EmployeeId => Token.EmployeeId;
